...
import { c as createLucideIcon$1, j as jsxRuntimeExports, a as createRoot, r as reactExports } from "./assets/createLucideIcon-64a3ef39.js";
  ...
  function documentContinue(code2) {
    ...
    if (self2.containerState._closeFlow) {
      ...
      while (index2 < self2.events.length) {
        self2.events[index2][1].end = __spreadValues({}, point2);
        index2++;
      }
...
function resolveToSetextUnderline(events, context) {
  ...
  const heading2 = {
    type: "setextHeading",
    start: __spreadValues({}, events[content2][1].start),
    end: __spreadValues({}, events[events.length - 1][1].end)
  };
  ...
  if (definition2) {
    ...
    events[content2][1].end = __spreadValues({}, events[definition2][1].end);
  } else {
    ...
    children: [
      {
        ...
        properties: __spreadProps(__spreadValues({}, structuredClone$1(footnoteLabelProperties)), {
          id: "footnote-label"
        }),
...
function createState(tree, options) {
  ...
  const handlers$1 = __spreadValues(__spreadValues({}, handlers), settings.handlers);
  const state = {
    all: all2,
    applyData,
    definitionById,
  ...
  function one2(node2, parent) {
    ...
    if (state.options.passThrough && state.options.passThrough.includes(type)) {
      if ("children" in node2) {
        const _a = node2, { children } = _a, shallow = __objRest(_a, ["children"]);
  ...
  if (destination && "run" in destination) {
    return function(tree, file) {
      return __async(this, null, function* () {
        ...
        yield destination.run(hastTree, file);
      });
    };
  }
  return function(tree, file) {
...
function Sidebar() {
  ...
  function handleMessage(e) {
    var _a;
    if (((_a = e.data) == null ? void 0 : _a.type) !== "PROBLEM_DATA")
      return;
  ...
  function loadProblemData() {
    ...
    chrome.runtime.sendMessage({ type: "GET_PROBLEM_DATA" }, (res) => {
      ...
      hydrateProblem(res == null ? void 0 : res.data);
    });
  }
  function hydrateProblem(data) {
    setProblemData(data != null ? data : null);
...
I can provide hints, explanations or help debug code. What can I do for you?`
      ...
      setMessages([
        {
          type: "assistant",
          content: "Hi! I couldn't read the current LeetCode problem. Try refreshing the page or press the ↻ button above."
        }
      ]);
    }
  }
  ...
  function sendMessage() {
    ...
    setInputValue("");
    setIsLoading(true);
    const systemPrompt = problemData ? `You are LeetBuddy, an AI assistant that helps with LeetCode. Current problem: "${problemData.title}" (${problemData.difficulty}). Description (truncated): ${(_a = problemData.description) == null ? void 0 : _a.slice(
      0,
      400
    ...
    chrome.runtime.sendMessage(
      ...
      (res) => {
        var _a2;
        setIsLoading(false);
        if (chrome.runtime.lastError || !(res == null ? void 0 : res.success)) {
          console.error((_a2 = res == null ? void 0 : res.error) != null ? _a2 : chrome.runtime.lastError);
          setMessages((prev) => [
            ...prev,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      (problemData == null ? void 0 : problemData.title) || "LeetCompanion",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
    ...
    }, children: quickActions.map((action, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { style: {
      ...
      fontWeight: 500,
      cursor: "pointer"
    }, onClick: () => setInputValue(action.fill), disabled: isLoading, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
      ...
      flexDirection: "column",
      gap: 10
    }, children: messages.map((msg, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
      ...
      maxWidth: "75%",
      boxShadow: "0 1px 4px 0 rgba(0,0,0,0.04)"
    }, children: msg.type === "assistant" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { children: msg.content }) : msg.content }, idx)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      display: "flex",
      alignItems: "center",
...
if (container) {
  ...
  root2.render(/* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, {}));
}
